...
public class CustomerMasterEntity implements Serializable{
	...
	private Date dob;
	private List<AccountMasterEntity> accounts;
	...
	public List<AccountMasterEntity> getAccounts() {
		return accounts;
	}
	public void setAccounts(List<AccountMasterEntity> accounts) {
	...
	public String toString() {
		...
		for(AccountMasterEntity account:this.getAccounts()){
